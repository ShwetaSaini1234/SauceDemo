...
public class LoginHomePage_SD {
	...
	public void admin_enter_valid_credentials_and_clicks_login_button_through_mouse() throws InterruptedException {
		...
		@Then("Error message please check username\\/password on login page {string}")
		public void error_message_please_check_username_password_on_login_page(String string) {
			
			loginHomePage.usrErrorMsg();
	}
